...
/**
 ...
 For a full GIF support, we recommend `FLAnimatedImage` or our less performant `DrantWebImageGIFCoder`
 ...
 */
@interface DrantWebImageImageIOCoder : NSObject <DrantWebImageProgressiveCoder>
