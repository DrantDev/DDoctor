...
#ifdef __OBJC_GC__
    #error DrantWebImage does not support Objective-C Garbage Collection
#endif
...
// Note: watchOS also has UIKit, but it's very limited
    ...
    #define DRANT_UIKIT 1
#else
    #define DRANT_UIKIT 0
#endif
    ...
    #import <AppKit/AppKit.h>
        ...
        #error DrantWebImage doesn't support Deployment Target version < 5.0
    #endif
...
FOUNDATION_EXPORT NSString *const DrantWebImageErrorDomain;
