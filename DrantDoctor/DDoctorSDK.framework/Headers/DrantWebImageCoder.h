 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const DrantWebImageCoderScaleDownLargeImagesKey;
 ...
 */
@protocol DrantWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {DrantWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
 ...
 */
- (BOOL)canEncodeToFormat:(DImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol DrantWebImageProgressiveCoder <DrantWebImageCoder>
