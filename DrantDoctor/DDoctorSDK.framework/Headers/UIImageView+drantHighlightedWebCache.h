...
/**
 * Integrates DrantWebImage async downloading and caching of remote images with UIImageView for highlighted state.
 */
@interface UIImageView (drantHighlightedWebCache)
 ...
 */
- (void)d_setHighlightedImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
