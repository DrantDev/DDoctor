...
/**
 ...
 Coders
 ------
 A coder must conform to the `DrantWebImageCoder` protocol or even to `DrantWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@interface DrantWebImageCodersManager : NSObject<DrantWebImageCoder>
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<DrantWebImageCoder>* coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<DrantWebImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<DrantWebImageCoder>)coder;
